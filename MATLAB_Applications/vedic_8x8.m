function out = vedic_8x8(a, b)
    ...
    [ad_8b_1s, ad_8b_1c] = adder_8b(v_4x4_2o, v_4x4_3o);

    % Shift and add upper bits of first partial with previous result
    [ad_8b_2s, ad_8b_2c] = adder_8b([0 0 0 0 v_4x4_1o(1:4)], ad_8b_1s);

    % Final addition with upper 4x4 product
    [ad_8b_3s, ad_8b_3c] = adder_8b([ad_8b_2c 0 0 0 ad_8b_2s(1:4)], v_4x4_4o);

    % Final output composition
    out = [ad_8b_3s, ad_8b_2s(5:8), v_4x4_1o(5:8)];
end
