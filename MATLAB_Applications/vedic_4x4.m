function out = vedic_4x4(a, b)
    ...
    % First 4-bit adder
    [ad_4b_1s, ad_4b_1c] = adder_4b(v_2x2_2o, v_2x2_3o);

    % Second 4-bit adder: add upper bits of v_2x2_1o and ad_4b_1s
    [ad_4b_2s, ad_4b_2c] = adder_4b([0 0 v_2x2_1o(1:2)], ad_4b_1s);

    % Third 4-bit adder
    [ad_4b_3s, ad_4b_3c] = adder_4b([ad_4b_1c 0 ad_4b_2s(1:2)], v_2x2_4o);
